const COLORS: Record<string, string> = {
  ...
  org_admin: 'bg-blue-500/15 text-blue-400 border-blue-500/30',
  manager: 'bg-blue-500/15 text-blue-400 border-blue-500/30',
  user: 'bg-gray-500/15 text-gray-400 border-gray-500/30',
  viewer: 'bg-pink-500/15 text-pink-400 border-pink-500/30',
  auto: 'bg-cyan-500/15 text-cyan-400 border-cyan-500/30',
  archived: 'bg-yellow-500/15 text-yellow-400 border-yellow-500/30',
  trashed: 'bg-red-500/15 text-red-400 border-red-500/30',
  compressed: 'bg-cyan-500/15 text-cyan-400 border-cyan-500/30',
};
